...
have user enter rps (confirm)
have computer generate rps (math gen assign to value of r p s)
copmare user vs computer entry(if/else for winner, tie , loser)
declare win lose or tie depending on values 
show score during each step 
run for 10 rounds
end of rounds show total score and declare winner, loser, or tie.